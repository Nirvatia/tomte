<script lang="ts">
  ...
  function handleDragLeave(e: DragEvent) {
    ...
    if (!related || !currentTarget.contains(related)) dropZoneActive = false;
  }
...
<div
  class="w-[400px] shrink-0 flex flex-col bg-surface border-l border-slate-200 overflow-hidden h-full"
>
  ...
  >
    ...
    {#if dropZoneActive}
      <div
        class="absolute inset-0 bg-brand-50/80 backdrop-blur-sm flex items-center justify-center pointer-events-none animate-fade-in rounded-lg"
      >
